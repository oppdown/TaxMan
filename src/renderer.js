...
function renderTransactionForm() {
  ...
  return `<section class="panel form-panel"><div class="panel-body"><div class="form-title"><div><h2>${draft.id ? 'Edit transaction' : 'Add transaction'}</h2><p>Enter one income or expense item. Amounts are stored in U.S. dollars.</p></div><div class="form-title-actions"><button type="button" class="secondary-button" data-action="cancel-form">← Back to all transactions</button><button type="button" class="icon-button" data-action="cancel-form" aria-label="Close form">✕</button></div></div><div class="entry-tip"><strong>Quick entry:</strong> Type dates as 090826. Ctrl+S saves, Esc cancels, and Ctrl+N starts a new expense.</div><form id="transaction-form"><div class="form-grid compact-form-grid">
